...
colors:
  ...
  ink: "#15181c"
  ink-soft: "#474d55"
  grid: "rgba(21, 24, 28, 0.08)"
  ink-faint: "rgba(21, 24, 28, 0.16)"

# Series colors lifted verbatim from the site this video explains
# (site/styles.css :root). The build script mapped the site's red onto
# paper-2, which is a background surface, so the role mapping above is set by
# hand instead. Red and green carry meaning on this chart (below and above
# break-even) and must never be used as decoration.
series:
  teal: "#1f6f8b"        # --series-1, the site's primary series
  amber: "#b07d2b"       # --series-2
  muted: "#7a8794"       # --series-3, the young-cohort grey
  positive: "#2e7d5b"    # --series-pos, at or above break-even
  negative: "#a8423a"    # --series-neg, below break-even
  depends: "#7c4a86"     # --depends, a projected or assumption-bound value
  rule: "#d6dade"
  rule-strong: "#b4bbc2"
